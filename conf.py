...
project = u'NIPY'
copyright = u'2005-2009, Neuroimaging in Python team'
...
# of the sidebar.
#html_logo = '_static/nipy-logo.png'
...
latex_documents = [
  ('index', 'nipywww.tex', u'NIPY Homepage',
